...
import com.guild.kotlin.adventurer.controller.impl.ReviewControllerImpl
...
class AddReview {
    ...
    @Autowired
    private var reviewControllerImpl: ReviewControllerImpl? = null
    ...
    private fun createNewReview(): Review {
        val review = Review()
        review.id = 1000
        review.authorId = 1
        review.jobId = 554
    ...
    fun add_new_report() {
        ...
        val newReport = createNewReviews()
        ...
        val SavedReport = newReport!!.id?.let { reviewRepository!!.findById(it) }!!.get()
...
//    }
    ...
    private fun createNewReviews(): Review {
        val review = createNewReview()
        reviewControllerImpl!!.save(review)
        return review
    }
